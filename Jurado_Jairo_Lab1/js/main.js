...
(function() {	
    var modernizrTest = function() {
        if(Modernizr.canvas) {
            ...
            ctx.fillText("Canvas is working", 10,180);
        } else {
            ctx.font = "10pt Verdana";
            ctx.fillText("Your browser does not support HTML5 canvas.")
        }
    }
    ...
    window.onload = function() {
        ...
        if(theCanvas && theCanvas.getContext) {
            ...
            if(ctx) {
                ...
                ctx.fillStyle = "#1b1bd1"; // shade of blue
                ctx.lineWidth = 10;
...
//Draw Circle here
        ...
        if(theCanvas2 && theCanvas2.getContext) {
            ...
            if(ctx2) {
                ctx2.fillStyle = "rgba(234, 17, 17, 0.5)"; // shade of red
                ctx2.strokeStyle = "black";
                
                ctx2.beginPath();
                ctx2.arc(50,50,20,0,2*Math.PI); // radius is 20px
                ctx2.closePath();
                ctx2.fill();
                
                ctx2.beginPath();
                ctx2.arc(50,50,30,0,2*Math.PI); // radius is 20px
                ctx2.closePath();
                ctx2.stroke();
            }
        }
...
//Draw text here
       var theCanvas5 = document.getElementById('Canvas5');
        ...
        if(theCanvas5 && theCanvas5.getContext) {
            ...
            if(ctx5) {
                var words = "'Blessed' NOT 'God Bless You' (Ephesians 1:3).";
                ctx5.font = "14pt Optima";
				ctx5.fillStyle = "green";
				ctx5.fillText(words, 20,160);
            }
        } 
...
// Draw scene here
    var theCanvas7 = document.getElementById('Canvas7');
        ...
        if(theCanvas7 && theCanvas7.getContext) {
            ...
            if(ctx7) {
                ctx7.strokeStyle = "#d3886c";
                
                ctx7.beginPath();
                ctx7.arc(50,50,40,0,2*Math.PI); // radius is 20px
                ctx7.closePath();
                ctx7.stroke();
                ...
                var name = "Jairo";
                ctx7.font = "14pt Verdana";
                ctx7.fillStyle = "purple";
                ctx7.fillText(name, 20, 160);
            }
        } 
    }
}) ();